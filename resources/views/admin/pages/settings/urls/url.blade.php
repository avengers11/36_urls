    ...
    <div class="container">
        ...
        <div class="card mt-5 mb-5">
            <div style="display: flex; align-items:center; justify-content:space-between" class="card-header">
                ...
                <span class="d-flex">
                    <a href="{{route("settings.urls_add_default_admin_urls_web")}}" class="btn btn-danger">Default Page</a>
                    <a href="{{route("settings.urls_add_admin_urls_web")}}" class="btn btn-success">New Url</a>
                </span>
                ...
                <tbody id="table_data">
                    @foreach ($urls as $item)
                        <tr>
                            ...
                            <td>{{$item['view']}}</td>
                            <td>
                                <a href="{{route("settings.urls_update_admin_urls_web", $item)}}?up={{$item['id']}}" class="btn btn-success">UPDATE</a>
