            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                    ...
                    @if (admin_data(session() -> get('username'))['role'] == "1")
                        ...
                        {{-- settings  --}}
                        <li class="nav-item {{Route::is('settings.*') || Route::is('category.*') ? 'active' : ''}}" data-toggle="tooltip" data-placement="right" title="Settings">
                            <a class="nav-link nav-link-collapse {{Route::is('settings.*') || Route::is('category.*') ? 'active' : ''}}" data-toggle="collapse" href="#collapseSettings" data-parent="#exampleAccordion">
                                <i class="fa-solid fa-gamepad"></i>
                                <span class="nav-link-text">Settings</span>
                            </a>
                            <ul class="sidenav-second-level {{Route::is('settings.*') || Route::is('category.*') ? 'show' : 'collapse'}}" id="collapseSettings">
                                <li>
                                    <a style="{{Route::is('category.admin_all_web') ? 'color: green !important' : ''}}" href="{{route('category.admin_all_web')}}">Category</a></a>
                                </li>
                                <li>
