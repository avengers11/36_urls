...
class admin_backend_settings_controller extends Controller
{
    ...
    */
    ...
    ====================
    */
    // admin_category_add_category_controller
    public function admin_category_add_category_controller(Request $req)
    {
    ...
    // admin_category_delete_category_controller
    public function admin_category_delete_category_controller($id)
    {
        $cat = Category::where('id', $id) -> first();
        urls::where('category_id', $cat->id) -> delete();
        Category::where('id', $id) -> delete();
        return back() -> with('msg', 'Successfully deleted!');
    }

    // admin_category_update_category_controller
    public function admin_category_update_category_controller(Request $req, $id)
    {
        $data = $req -> all();
        ...
        return back() -> with('msg', 'Your movie category successfully updated!');
    }
